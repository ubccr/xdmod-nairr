...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="gui/css/orcid_login.css"/>
    <?php if ($userLoggedIn): ?>
...
JS;
		...
		$ssoLinkText = '';
                try {
                    $ssoLinkText = xd_utilities\getConfiguration('sso', 'link_text');
                } catch (Exception $e) {
                }
		...
		print "CCR.xdmod.SSOLinkText = '" . $ssoLinkText . "';\n";
            } else {
